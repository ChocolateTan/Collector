    ...
    def create_md_file(self, path, month, page):
        ...
        with open(filename, 'w') as f:
            for item in data:
                ...
                f.write('function onClickAction(id){\n')
                f.write('var e = document.getElementById("div_"+id);\n')
                f.write('var a = document.getElementById("a_"+id);\n')
                f.write('if(e.style.display == \'none\'){\n')
                f.write('e.style.display = \'\';\n')
                f.write('a.innerHTML = "[展开]";\n')
                f.write('}else{')
                f.write('e.style.display = \'none\';')
                f.write('a.innerHTML = "[收起]";\n')
                f.write('}\n')
                f.write('}')
                f.write('</script>\n')
                f.write('\n')
